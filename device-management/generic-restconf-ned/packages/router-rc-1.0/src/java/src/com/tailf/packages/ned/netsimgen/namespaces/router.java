...
public class router extends ConfNamespace {
    ...
    public static final long serialVersionUID = 1337740777L;

    public static final int hash = 1337740777;
    public int hash() {
        return router.hash;
    }

    public static final String id = "_router-gen-1.0:router-gen-1.0#http://example.com/router";
    public String id() {
        return router.id;
    }

    public static final String uri = "_router-gen-1.0:router-gen-1.0#http://example.com/router";
    public String uri() {
        return router.uri;
    }

    public String xmlUri() {
        return ConfNamespace.truncateToXMLUri(router.uri);
    }
