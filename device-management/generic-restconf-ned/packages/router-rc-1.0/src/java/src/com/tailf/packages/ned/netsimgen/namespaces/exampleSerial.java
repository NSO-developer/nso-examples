...
public class exampleSerial extends ConfNamespace {
    ...
    public static final long serialVersionUID = 120061158L;

    public static final int hash = 120061158;
    public int hash() {
        return exampleSerial.hash;
    }

    public static final String id = "_router-gen-1.0:router-gen-1.0#http://example.com/example-serial";
    public String id() {
        return exampleSerial.id;
    }

    public static final String uri = "_router-gen-1.0:router-gen-1.0#http://example.com/example-serial";
    public String uri() {
