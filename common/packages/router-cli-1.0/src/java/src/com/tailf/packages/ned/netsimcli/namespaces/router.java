...
public class router extends ConfNamespace {
    ...
    public static final long serialVersionUID = 487129873L;

    public static final int hash = 487129873;
    public int hash() {
        return router.hash;
    }

    public static final String id = "_router-cli-1.0:router-cli-1.0#http://example.com/router";
    public String id() {
        return router.id;
    }

    public static final String uri = "_router-cli-1.0:router-cli-1.0#http://example.com/router";
    public String uri() {
        return router.uri;
    }
