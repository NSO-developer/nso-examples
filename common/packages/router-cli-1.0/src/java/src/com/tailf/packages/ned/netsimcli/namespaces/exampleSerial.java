...
public class exampleSerial extends ConfNamespace {
    ...
    public static final long serialVersionUID = 214528007L;

    public static final int hash = 214528007;
    public int hash() {
        return exampleSerial.hash;
    }

    public static final String id = "_router-cli-1.0:router-cli-1.0#http://example.com/example-serial";
    public String id() {
        return exampleSerial.id;
    }

    public static final String uri = "_router-cli-1.0:router-cli-1.0#http://example.com/example-serial";
    public String uri() {
        return exampleSerial.uri;
    }

    public String xmlUri() {
        return ConfNamespace.truncateToXMLUri(exampleSerial.uri);
    }
