...
The alternative `demo_maapi.py` script uses Python MAAPI/maagic transactions to
configure the blast-radius limit, commit two-device changes, and demonstrate
the aborted three-device transaction.
