...
public class router extends ConfNamespace {
    ...
    public static final long serialVersionUID = 207721635L;

    public static final int hash = 207721635;
    public int hash() {
        return router.hash;
    }

    public static final String id = "_router-nc-1.0:router-nc-1.0#http://example.com/router";
    public String id() {
        return router.id;
    }

    public static final String uri = "_router-nc-1.0:router-nc-1.0#http://example.com/router";
    public String uri() {
        return router.uri;
    }
