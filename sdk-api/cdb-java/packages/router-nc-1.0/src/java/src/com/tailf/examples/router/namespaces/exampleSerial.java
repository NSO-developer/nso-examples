...
public class exampleSerial extends ConfNamespace {
    ...
    public static final long serialVersionUID = 1285368182L;

    public static final int hash = 1285368182;
    public int hash() {
        return exampleSerial.hash;
    }

    public static final String id = "_router-nc-1.0:router-nc-1.0#http://example.com/example-serial";
    public String id() {
        return exampleSerial.id;
    }

    public static final String uri = "_router-nc-1.0:router-nc-1.0#http://example.com/example-serial";
    public String uri() {
