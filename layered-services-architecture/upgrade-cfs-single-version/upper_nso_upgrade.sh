...
function usage()
{
   printf "${GREEN}Demo upgrading the lsa-single-version-deployment\n"
...
printf "\n${PURPLE}##### Exit from the CLI, stop the upper layer NSO instances and switch from $OLD_VERSION to the newer NSO $NEW_VERSION version\n${NC}"
env $NODE1 ncs --stop
