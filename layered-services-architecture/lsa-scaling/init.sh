...
IPC_PATH="${NCS_IPC_PATH:-/tmp/nso/nso-ipc}"
NODE1="NCS_IPC_PATH=${IPC_PATH}.4569"
NODE2="NCS_IPC_PATH=${IPC_PATH}.4570"
NODE3="NCS_IPC_PATH=${IPC_PATH}.4571"
NODE4="NCS_IPC_PATH=${IPC_PATH}.4572"
fi
